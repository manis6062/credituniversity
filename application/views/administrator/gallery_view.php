                ...
                <div class="box span12">
                    ...
                    <div class="box-content">
                        ...
                        <?php
                            ...
                            echo form_open_multipart(ADMIN_PATH . 'gallery/remove_checked', $attributes);
                        ?>
                    ...
                    if ($photoList != 0 && count($photoList) > 0) {
                        ...
                        foreach ($photoList as $values) {
                            ?>
                            <tr class="item">
                                <td><?php echo $count; ?><input type="checkbox" name="msg[]" value="<?php echo $values->gallery_id; ?>" />
                                    <input type="hidden" name="album" value="<?php echo $values->album_id; ?>" />                                    
                                </td>
