...
<script>
        function showClient(data) {
            ...
            window.location = "<?php echo base_url().'administrator/creditcard/returned/';?>"+data.value;
    ...
    <div class="row-fluid ui-sortable">
        ...
        <?php          
                        ...
                        <?php
                            ...
                            echo form_open_multipart(ADMIN_PATH . 'creditcard/addCheckedClientToCardReturned', $attributes);
                        ?>
                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                          ...
                          <?php if($linecard!='' && count($linecard)!=0){
                            ...
                            <tr class="<?php if($key%2 == 0){ echo 'even';}else{echo 'odd';}?>">
                                <?php if(!empty($cardid)){?>
                                <td><input type="radio" name="cardid[]" value="<?php echo $val->card_id; ?>" <?php if($cardid == $val->card_id){echo 'checked="checked"';}?> onclick="showClient(this)" /></td>
                                <?php } else{ ?>
                                ...
                                <input type="hidden" name="ref_id[]" value = "<?php echo $val->referrer_id; ?>" >
                            </tr>
                            <?php }
                            }
                            ?>
        ...
        <div class="box span4">
                    <div class="box-header well" data-original-title>
                        <h2><i class="icon-user"></i> Returned Clients</h2>
...
<button type="button" data-toggle="popover<?php echo $key;?>" data-placement="top" title="Line Lists" data-trigger="focus"
	data-content=" <ul><?php 
    foreach($cardinforeturn as $val1){
