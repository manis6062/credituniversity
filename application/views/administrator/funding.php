    ...
    <section class="content">
            ...
            <div class="box-body">
                ...
                <div class="form-group  col-md-12">
                    ...
                    <strong>Title :</strong> Funding <?php echo $funding->name ?>
                    <div class="clearfix " style="margin-top: 15px;"></div>
                    <strong>Description:</strong>   <?php echo $funding->description ;?>

                </div>
                <div class="form-group  col-md-12">
                    <object data="<?php echo base_url('uploads/pdf_content/' . $funding->file) ?>" height="800px" width="100%">
                        <p>Your web browser doesn't have a PDF Plugin. Instead you can <a href="http://partners.adobe.com/public/developer/en/acrobat/PDFOpenParameters.pdf"> Click
                                here to download the PDF</a></p> </object>
