	...
	<div class="container">
		...
		<div class="col-lg-6">
			...
			<?php $attributes = array('id' => 'login-form', 'class' => 'form-horizontal box1');
				echo form_open(base_url() . 'register/signup_referrer', $attributes);
			?>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					...
					<input type="text" autocomplete="off" name="userCaptcha" placeholder="Enter above text"
						   value="<?php if (!empty($userCaptcha)) {
							   echo $userCaptcha;
						   } ?>"/>
					<span><?php echo form_error('userCaptcha', '<p style="color:#F83A18">', '</p>'); ?></span>
				</div>
			</div>
