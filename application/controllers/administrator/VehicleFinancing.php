...
class VehicleFinancing extends AdminController
{
    ...
    public function index()
    {
        ...
        $data['member_module'] = $this->ModuleModel->getMemberModules('vehicle_financing');
        $data['main_content'] = ADMIN_PATH . "vehicleFinancing";
